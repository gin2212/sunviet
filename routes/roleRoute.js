...
router.delete('/deleteMany', middlewares.authorize, roleController.deleteManyRoles);
...
router.get('/getManagementRole',middlewares.authorize, roleController.getRoleManagementPage);
